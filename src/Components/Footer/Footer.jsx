        ...
        <div className='footer py-4'>
            <div className='d-flex justify-content-center row footerHead py-5'>
                <div className='col-lg-6 col-12 text-center my-lg-0 my-3'>
                    <div className='headerText1 heading-text'>Keep In Touch</div>
                    <div className='headerText2 heading-text'>Travel With Us</div>
                </div>
                ...
                <div className='col-lg-3 col-md-2 col-4 my-auto'>
                    <button className='btn footerBtn rounded-5'>
                        <span className='mx-1 paragraph-text'>Send</span> 
                ...
                <div className='row footerBodyContent'>
                    <div className='col-lg-6 col-12'>
                        <div className='d-flex my-2'>
                            ...
                            <div className="brand-name heading-text">Travel.</div>
                        </div>
                        <p className='footerBodyText paragraph-text'>
                            Embark on unforgettable adventures with us. Discover exotic destinations, create lasting memories, and let our expert guides enhance your journey. Explore the world with confidence, knowing your wanderlust is in capable hands. Your dream getaway begins here. Bon voyage!
                        </p>
                        <div className='my-2'>
                            <a href="https://www.instagram.com" className='footerLink me-2'>
                                <FontAwesomeIcon icon={faInstagram} size='xl' />
                            </a>
                            <a href="https://www.twitter.com" className='footerLink mx-2'>
                                <FontAwesomeIcon icon={faXTwitter} size='xl' />
                            </a>
                            <a href="https://www.linkedin.com" className='footerLink mx-2'>
                                <FontAwesomeIcon icon={faLinkedin} size='xl' />
                            </a>
                            <a href="https://www.facebook.com" className='footerLink mx-2'>
