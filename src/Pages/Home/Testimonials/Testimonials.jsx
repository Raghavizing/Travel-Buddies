...
function Testimonials() {
  function createCarousel(props) {
    return (
      <Carousel key={props.id} id={props.id} image={props.image} name={props.name} testimony={props.testimony} date={props.date} />
    )
  }
      ...
      <div className={props.id === 1 ? "carousel-item active" : "carousel-item"}>
        <div>
          ...
          <div className="d-flex justify-content-center">
            <img src={props.image} className="d-block carousel-img mx-5" alt="..." />
            <div className='my-auto'><div className='user-details1 paragraph-text'>{props.name}</div>
              <div className='user-details2 paragraph-text'>{props.date}</div></div>
          </div>
        </div>
      </div>
  ...
  return (<div className='testimonials'>
    <div className='testimonials-header p-0 heading-text'>Customer <span className='blue-underline'>Testimonials.</span></div>
